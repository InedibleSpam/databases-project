        ...
        html += `
            <div class="flight-card">
                ...
                <div class="flight-seats">
                    ...
                    <span class="seats-value" style="color: ${seatColor}; font-weight: bold;">${
                        seatsText
                    }</span>
                </div>
                <div class="flight-action">
                    <button 
                        onclick="bookFlight('${flight.log_id}', '${
                            flight.unit_price
...
function bookFlight(
    ...
    const depart_date = dateInput.value;
    const totalPrice = parseFloat(unit_price) * parseInt(num_tickets);
    
    const confirmMessage = `Are you sure you wish to purchase ${num_tickets} ticket(s) for the flight on ${depart_date} for a total price of $${totalPrice.toFixed(2)}?`;
    ...
    if (confirm(confirmMessage)) {
        ...
        window.location.href = `/purchase?${query}`; 
    }
}
